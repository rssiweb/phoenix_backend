...
class StatusErrors(object):
    ...
    INVALID_FORMAT = StatusErrorValues('INVALID_FORMAT', methodcaller('__getitem__', slice(None, 2)))
    ...
    INVALID_VALUE_TYPE = StatusErrorValues('INVALID_VALUE_TYPE', methodcaller('__getitem__', slice(None, 2)))
