...
def upgrade():
    ...
    op.add_column('student', sa.Column('branch_id', sa.Integer(), nullable=False, default=1))
    op.add_column('student', sa.Column('category_id', sa.Integer(), nullable=False, default=1))
